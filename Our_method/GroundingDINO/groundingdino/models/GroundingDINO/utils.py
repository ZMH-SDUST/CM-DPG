...
class ContrastiveEmbed(nn.Module):
    ...
    def forward(self, x, text_dict):
        ...
        y = text_dict["encoded_text"]  # [1, 309, 256]

        text_token_mask = text_dict["text_token_mask"]  # [1, 309]

        # x [1, 900, 256]
        # res [1, 900, 309]
        res = x @ y.transpose(-1, -2)
        # Fill positions where text_token_mask is false (invalid tokens) in res with negative infinity.
