...
# GLIP dataset
with open('./data/visual_genome/final_mixed_train_no_coco.json',
          'r') as fin:  # please refer to https://github.com/microsoft/GLIP for downloading
    res = json.load(fin)
print(res.keys())
...
fns, img_info = load_image_filenames("./data/stanford_filtered/image_data.json")
print(img_info[0])
roidb_file = "./data/stanford_filtered/VG-SGG-with-attri.h5"
...
roi_h5.close()
roi_h5 = h5py.File("./data/stanford_filtered/VG-SGG-with-attri.h5", 'r')
