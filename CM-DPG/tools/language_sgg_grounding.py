...
def get_model(model_card='swinb'):
    if model_card == 'swinb':
        model_config_path = "../cmdpg/groundingdino/config/GroundingDINO_SwinB_pretrain.py"
    else:
        model_config_path = "../cmdpg/groundingdino/config/GroundingDINO_SwinT_OGC_pretrain.py"
    ...
    if model_card == 'swinb':
        model_checkpoint_path = "../cmdpg/weights/swinb_cogcoor.pth"
    else:
        model_checkpoint_path = '../cmdpg/weights/swint_ogc.pth'
